...
BEARBEITEN_M = u'''Bearbeiten'''
ANSICHT = u'''Ansicht'''
FILE = u'''Datei'''
TITEL = u'''Titel'''
PAPIERKORB = u'''Papierkorb'''
FORMATIERUNG_SPEICHERN = u'''Speichern der Formatierung des zuletzt bearbeiteten Bereiches: {0}'''
DATEI_NICHT_GESPEICHERT = u'''Datei konnte nicht gespeichert werden'''
KEINE = u'''Keine'''
KAPITEL = u'''Kapitel'''
SZENE = u'''Szene'''
NEW_PROJECT = u'''Neues Projekt'''
OPEN_PROJECT = u'''Projekt öffnen'''
LOAD_DESCRIPTION = u'''Anleitung laden'''
...
KEIN_NAME = u'''Sie haben noch keinen Namen eingegeben.'''
KEIN_SPEICHERORT = u'''Sie haben noch keinen Speicherort ausgesucht.'''
...
NOCH_IN_TAB_GEOEFFNET = u'''{0} ist noch in {1} geöffnet'''
...
EXPORT_NICHT_ERFOLGREICH = u'''Der Export hat nicht funktioniert!'''
ALLES = u'''Alles'''
SICHTBARE = u'''Sichtbare'''
AUSWAHL = u'''Auswahl'''
EXPORTIEREN_ALS = u'''exportieren als'''
EIN_DOKUMENT = u'''ein Dokument'''
TRENNER = u'''Trenner'''
BEARBEITEN = u'''bearbeiten'''
EINZ_DATEIEN = u'''einzelne Dateien'''
ORDNERSTRUKTUR = u'''Ordnerstruktur beibehalten'''
DATEITYP = u'''Dateityp:'''
EXPORTIEREN = u'''exportieren'''
TRENNER_TIT = u'''TRENNER'''
AUSWAHL_TIT = u'''AUSWAHL'''
ORDNERTITEL = u'''Ordnertitel'''
FORMAT = u'''Format'''
DATEITITEL = u'''Dateititel'''
ORT_DES_DOKUMENTS = u'''Dokument'''
LEERZEILEN = u'''Leerzeilen'''
ANZAHL_LEERZEILEN = u'''Anzahl darunter einzufügender Leerzeilen'''
DOK_EINFUEGEN = u'''Dokument einfügen'''
WAEHLEN = u'''wählen'''
SEITENUMBRUCH_ORD = u'''Seitenumbruch vor Ordner'''
SEITENUMBRUCH_DAT = u'''Seitenumbruch vor Datei'''
ORDNER_CLICK = u'''Klick auf Ordner wählt Untereintraege aus'''
NICHTS_AUSGEWAEHLT = u'''Es sind keine Dateien zum Export ausgewählt'''
EXPORT_BITTE_WARTEN = u'''Exportiere. Bitte warten.'''
...
IMPORT_DATEI = u'''Datei importieren'''
IMPORT_ORDNER = u'''Ordner importieren'''
DATEIAUSWAHL = u'''Datei auswählen'''
ORDNERAUSWAHL = u'''Ordner auswählen'''
IMPORTIEREN = u'''Importieren'''
FILTER = u'''Filter'''
...
NOTIZEN = u'''Notizen'''
BILDER = u'''Bilder'''
ALLGEMEIN = u'''Allgemein'''
CHARAKTERE = u'''Personen'''
ORTE = u'''Orte'''
OBJEKTE = u'''Objekte'''
ZEIT = u'''Zeit'''
BENUTZER1 = u'''Benutzer 1'''
...
UNAUSGEZEICHNETE = u'''nicht ausgezeichnete Dateien einbeziehen'''
NUTZE_ZEIT = u'''nutze Zeit'''
NUTZE_DATUM = u'''nutze Datum'''
...
KONSOLENAUSGABE = u'''Konsolenausgabe'''
...
ZITATE_FINDEN = u'''Zitate finden'''
AUSGEWAEHLTER_ORDNER_WAEHLT = u'''Die Auswahl eines Ordners wählt seinen Inhalt mit aus'''

FUNDSTELLEN = u'''Fundstellen: {0}'''
VERSIONEN_TXT1 = u'''Versionen Text 1: {0}'''
VARIANTEN_TXT2 = u'''Varianten Text 2: {0}'''
NAVIGATION = u'''Navigation'''
SUCHWOERTER = u'''Anzahl Suchwörter: {0}'''
...
ZEILE = u'''Zeile'''
AUSGEWAEHLTE_ZEILE = u'''ausgewählt'''
EDITIERTE_ZEILE = u'''bearbeitet'''
GEZOGENE_ZEILE = u'''gezogen'''
...
NICHT_ALLE_DESIGNS_LOESCHEN = u'''Sie können nicht alle Designs löschen'''
