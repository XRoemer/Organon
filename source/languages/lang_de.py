...
TEMPLATE_USER = 'Eigene Formatvorlage'
NO_TEMPLATES = 'keine Vorlagen'
EIGENES_TEMPL_ERSTELLEN = 'Formatvorlage aus Auswahl erstellen'
NAME = 'Name'
ERSTELLEN = 'Erstellen'
TEMPLATE = 'Template'
...
###### ZITATE FINDEN ######
DATEI_AUSSUCHEN = 'Datei aussuchen'
ORDNER_AUSSUCHEN = 'Ordner aussuchen'
TEXTVERGLEICH = 'Textvergleich: Zitate finden '
